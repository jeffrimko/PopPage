...
Before showing any examples, keep these notes in mind:
  ...
  - The output will be passed to `stdout` if INPATH is a file (rather than a directly) and the template filename does not contain a template variable and no OUTPATH is specified.
